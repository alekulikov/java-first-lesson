...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("""
                %naByte + aByte * aShort - 15L + 1.5F + 1.08 - 10
                Сначала, перед вычислением aByte + aByte * aShort значения переменных будут расширены до int, затем,
                ...
                вычисления aByte + aByte * aShort - 15L будет расширен до float. Перед выполнением сложения с числом
                1.08 результат предыдущих вычислений будет расширен до double (поскольку вещественные константы по
                умолчанию имеют тип double) и, наконец, перед выполнением последнего сложения литерал 10 (по умолчанию
                int) будет расширен до double. Таким образом, результат вычисления выражения будет иметь тип
                double - %.2f.
